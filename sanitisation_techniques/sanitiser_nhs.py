...
class SanitiserNHSLegacy(SanitiserNHS):
    """ Emulate the bugged version of SanitiserNHS as implemented in the original repo """
    def __init__(self, metadata,
                 nbins=10, thresh_rare=0,
                 max_quantile = 1, anonymity_set_size=1,
                 drop_cols=None, quids=None):
        super().__init__(metadata, nbins, thresh_rare, max_quantile, anonymity_set_size, drop_cols, quids)

        self.__name__ = f'SanitiserNHSLegacyk{self.anonymity_set_size}'
